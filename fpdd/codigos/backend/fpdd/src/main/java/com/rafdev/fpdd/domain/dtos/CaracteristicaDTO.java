...
public class CaracteristicaDTO extends AbstractBackingDTO<Caracteristica, Long> {
	...
	public CaracteristicaDTO(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs,
	...
	public CaracteristicaDTO(Caracteristica obj) {
		super();
		this.id = obj.getId();
	...
	public String toString() {
		return "CaracteristicaDTO [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr="

...
public class ClasseDTO extends AbstractBackingDTO<Classe, Long> {
	...
	public ClasseDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public String toString() {
		return "ClasseDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

...
public class CorCabeloDTO extends AbstractBackingDTO<CorCabelo, Long> {
	...
	public CorCabeloDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public CorCabeloDTO(CorCabelo obj) {
		super();
		this.id = obj.getId();
	...
	public CorCabelo toEntity() {
		return new CorCabelo(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CorCabeloDTO other = (CorCabeloDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "CorCabeloDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

...
public class CorOlhosDTO extends AbstractBackingDTO<CorOlhos, Long> {
	...
	public CorOlhosDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public CorOlhosDTO(CorOlhos obj) {
		super();
		this.id = obj.getId();
	...
	public CorOlhos toEntity() {
		return new CorOlhos(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CorOlhosDTO other = (CorOlhosDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "CorOlhosDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

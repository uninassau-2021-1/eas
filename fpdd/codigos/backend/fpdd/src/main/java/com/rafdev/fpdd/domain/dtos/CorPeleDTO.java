...
public class CorPeleDTO extends AbstractBackingDTO<CorPele, Long> {
	...
	public CorPeleDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public CorPele toEntity() {
		return new CorPele(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CorPeleDTO other = (CorPeleDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "CorPeleDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

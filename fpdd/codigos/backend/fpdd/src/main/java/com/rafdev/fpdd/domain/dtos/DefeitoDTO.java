...
public class DefeitoDTO extends AbstractBackingDTO<Defeito, Long> {
	...
	public DefeitoDTO(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs,
	...
	public Defeito toEntity() {
		return new Defeito(this);
	}
	...
	public String toString() {
		return "DefeitoDTO [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr

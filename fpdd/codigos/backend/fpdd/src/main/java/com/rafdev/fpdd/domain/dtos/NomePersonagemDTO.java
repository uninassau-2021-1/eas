...
public class NomePersonagemDTO extends AbstractBackingDTO<NomePersonagem, Long> {
	...
	public NomePersonagemDTO() {
		super();
	}

	public NomePersonagemDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public NomePersonagemDTO(NomePersonagem obj) {
		super();
		this.id = obj.getId();
	...
	public NomePersonagem toEntity() {
		return new NomePersonagem(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NomePersonagemDTO other = (NomePersonagemDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "NomePersonagemDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

...
public class SubRacaDTO extends AbstractBackingDTO<SubRaca, Long> {
	...
	public SubRacaDTO(Long id, Raca raca, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
		this.raca = raca;
	...
	public SubRaca toEntity() {
		return new SubRaca(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SubRacaDTO other = (SubRacaDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "SubRacaDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

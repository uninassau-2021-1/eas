...
public class TendenciaDTO extends AbstractBackingDTO<Tendencia, Long> {
	...
	public TendenciaDTO(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public TendenciaDTO(Tendencia obj) {
		super();
		this.id = obj.getId();
	...
	public Tendencia toEntity() {
		return new Tendencia(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TendenciaDTO other = (TendenciaDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "TendenciaDTO [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

...
public class TracoDTO extends AbstractBackingDTO<Traco, Long> {
	...
	public TracoDTO(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
	...
	public Traco toEntity() {
		return new Traco(this);
	}
	...
	public String toString() {
		return "TracoDTO [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr

...
public class VinculoDTO extends AbstractBackingDTO<Vinculo, Long> {
	...
	public VinculoDTO(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs,
	...
	public Vinculo toEntity() {
		return new Vinculo(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VinculoDTO other = (VinculoDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "VinculoDTO [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr

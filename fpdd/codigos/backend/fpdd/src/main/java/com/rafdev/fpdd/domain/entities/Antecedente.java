...
@Entity
@Table(name = Antecedente.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class Antecedente extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "ANTEC";

	public static final String TABLE_NAME = "TBANTECEDENTEFPDD";

	public static final String COLUMN_ID = "CANTECCODIGO";
	public static final String COLUMN_NOME_EN = "NANTECNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NANTECNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NANTECNOMEES";
	public static final String COLUMN_OBSERVACAO = "XANTECOBSERVACAO";
	public static final String COLUMN_STATUS = "FANTECSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TANTECULAT";
	...
	public Antecedente(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public Antecedente(AntecedenteDTO obj) {
		super();
		this.id = obj.getId();
	...
	public AntecedenteDTO toDto() {
		return new AntecedenteDTO(this);
	}
	...
	public String toString() {
		return "Antecedente [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

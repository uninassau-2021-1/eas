...
import com.rafdev.fpdd.domain.dtos.ClasseDTO;
...
@Entity
@Table(name = Classe.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class Classe extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "CLASS";

	public static final String TABLE_NAME = "TBCLASSEFPDD";

	public static final String COLUMN_ID = "CCLASSCODIGO";
	public static final String COLUMN_NOME_EN = "NCLASSNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NCLASSNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NCLASSNOMEES";
	public static final String COLUMN_OBSERVACAO = "XCLASSOBSERVACAO";
	public static final String COLUMN_STATUS = "FCLASSSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TCLASSULAT";
	...
	public Classe(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public String toString() {
		return "Classe [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

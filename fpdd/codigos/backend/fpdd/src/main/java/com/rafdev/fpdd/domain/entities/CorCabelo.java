...
@Entity
@Table(name = CorCabelo.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class CorCabelo extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "CRCBL";

	public static final String TABLE_NAME = "TBCORCABELOFPDD";

	public static final String COLUMN_ID = "CCRCBLCODIGO";
	public static final String COLUMN_NOME_EN = "NCRCBLNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NCRCBLNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NCRCBLNOMEES";
	public static final String COLUMN_OBSERVACAO = "XCRCBLOBSERVACAO";
	public static final String COLUMN_STATUS = "FCRCBLSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TCRCBLULAT";
	...
	public CorCabelo(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public CorCabelo(CorCabeloDTO obj) {
		super();
		this.id = obj.getId();
	...
	public CorCabeloDTO toDto() {
		return new CorCabeloDTO(this);
	}
	...
	public String toString() {
		return "CorCabelo [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

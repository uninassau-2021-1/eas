...
@Entity
@Table(name = CorOlhos.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class CorOlhos extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "CROLH";

	public static final String TABLE_NAME = "TBCOROLHOSFPDD";

	public static final String COLUMN_ID = "CCROLHCODIGO";
	public static final String COLUMN_NOME_EN = "NCROLHNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NCROLHNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NCROLHNOMEES";
	public static final String COLUMN_OBSERVACAO = "XCROLHOBSERVACAO";
	public static final String COLUMN_STATUS = "FCROLHSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TCROLHULAT";
	...
	public CorOlhos(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao, StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public CorOlhos(CorOlhosDTO obj) {
		super();
		this.id = obj.getId();
	...
	public CorOlhosDTO toDto() {
		return new CorOlhosDTO(this);
	}
	...
	public String toString() {
		return "CorOlhos [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

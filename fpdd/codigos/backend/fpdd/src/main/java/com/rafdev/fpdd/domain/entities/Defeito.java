...
import com.rafdev.fpdd.domain.dtos.DefeitoDTO;
...
@Entity
@Table(name = Defeito.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class Defeito extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "DEFTO";

	public static final String TABLE_NAME = "TBDEFEITOFPDD";

	public static final String COLUMN_ID = "CDEFTOCODIGO";
	public static final String COLUMN_ANTECEDENTE = "CANTECCODIGO";
	public static final String COLUMN_NOME_EN = "NDEFTONOMEEN";
	public static final String COLUMN_NOME_PTBR = "NDEFTONOMEPTBR";
	public static final String COLUMN_NOME_ES = "NDEFTONOMEES";
	public static final String COLUMN_OBSERVACAO = "XDEFTOOBSERVACAO";
	public static final String COLUMN_STATUS = "FDEFTOSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TDEFTOULAT";
	...
	public Defeito(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
	...
	public DefeitoDTO toDto() {
		return new DefeitoDTO(this);
	}
	...
	public String toString() {
		return "Defeito [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr

...
@Entity
@Table(name = NomePersonagem.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class NomePersonagem extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "NMPSG";

	public static final String TABLE_NAME = "TBNOMEPERSFPDD";

	public static final String COLUMN_ID = "CNMPSGCODIGO";
	public static final String COLUMN_NOME_EN = "NNMPSGNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NNMPSGNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NNMPSGNOMEES";
	public static final String COLUMN_OBSERVACAO = "XNMPSGOBSERVACAO";
	public static final String COLUMN_STATUS = "FNMPSGSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TNMPSGULAT";
	...
	public NomePersonagem(Long id, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
		this.nomeEn = nomeEn;
	...
	public NomePersonagem(NomePersonagemDTO obj) {
		super();
		this.id = obj.getId();
	...
	public NomePersonagemDTO toDto() {
		return new NomePersonagemDTO(this);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NomePersonagem other = (NomePersonagem) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "NomePersonagem [id=" + id + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs=" + nomeEs

...
import com.rafdev.fpdd.domain.dtos.SubRacaDTO;
...
@Entity
@Table(name = SubRaca.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class SubRaca extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "TBSUBRACAFPDD";

	public static final String COLUMN_ID = "CSBRACCODIGO";
	public static final String COLUMN_RACA = "CRACASCODIGO";
	public static final String COLUMN_NOME_EN = "NSBRACNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NSBRACNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NSBRACNOMEES";
	public static final String COLUMN_OBSERVACAO = "XSBRACOBSERVACAO";
	public static final String COLUMN_STATUS = "FSBRACSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TSBRACULAT";
	...
	public SubRaca(Long id, Raca raca, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
		this.raca = raca;
	...
	public SubRacaDTO toDto() {
		return new SubRacaDTO(this);
	}
	...
	public String toString() {
		return "SubRaca [id=" + id + ", raca=" + raca + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr + ", nomeEs="
				+ nomeEs + ", observacao=" + observacao + ", status=" + status + ", ultimaAtualizacao="
				+ ultimaAtualizacao + "]";
	}

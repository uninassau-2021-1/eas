...
import com.rafdev.fpdd.domain.dtos.VinculoDTO;
...
@Entity
@Table(name = Vinculo.TABLE_NAME, schema = AbstractBackingEntity.SCHEMA_FPDD_NAME)
public class Vinculo extends AbstractBackingEntity<Long> {
	private static final long serialVersionUID = 1L;

	public static final String SIGLA = "VINCU";

	public static final String TABLE_NAME = "TBVINCULOFPDD";

	public static final String COLUMN_ID = "CVINCUCODIGO";
	public static final String COLUMN_ANTECEDENTE = "CANTECCODIGO";
	public static final String COLUMN_NOME_EN = "NVINCUNOMEEN";
	public static final String COLUMN_NOME_PTBR = "NVINCUNOMEPTBR";
	public static final String COLUMN_NOME_ES = "NVINCUNOMEES";
	public static final String COLUMN_OBSERVACAO = "XVINCUOBSERVACAO";
	public static final String COLUMN_STATUS = "FVINCUSTATUS";
	public static final String COLUMN_ULTIMA_ATUALIZACAO = "TVINCUULAT";
	...
	public Vinculo(Long id, Antecedente antecedente, String nomeEn, String nomePtBr, String nomeEs, String observacao,
			StatusEnum status) {
		super();
		this.id = id;
	...
	public VinculoDTO toDto() {
		return new VinculoDTO(this);
	}
	...
	public String toString() {
		return "Vinculo [id=" + id + ", antecedente=" + antecedente + ", nomeEn=" + nomeEn + ", nomePtBr=" + nomePtBr

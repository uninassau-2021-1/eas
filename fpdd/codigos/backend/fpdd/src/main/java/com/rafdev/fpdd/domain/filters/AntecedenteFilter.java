...
public class AntecedenteFilter extends AbstractBackingFilter<Antecedente, Long> {
	...
	@Override
	public AntecedenteFilter getFilterDecoded() {
		AntecedenteFilter filter = new AntecedenteFilter();
	...
	public String toString() {
		return "AntecedenteFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnEquals="
				+ nomeEnLike + ", nomePtBrEquals=" + nomePtBrLike + ", nomeEsEquals=" + nomeEsLike + ", statusEquals="
				+ statusEquals + "]";
	}

...
public class CaracteristicaFilter extends AbstractBackingFilter<Caracteristica, Long> {
	...
	@Override
	public CaracteristicaFilter getFilterDecoded() {
		CaracteristicaFilter filter = new CaracteristicaFilter();
	...
	public String toString() {
		return "CaracteristicaFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", antecedenteEquals="

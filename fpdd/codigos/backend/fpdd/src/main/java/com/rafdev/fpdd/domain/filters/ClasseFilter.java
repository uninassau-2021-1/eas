...
public class ClasseFilter extends AbstractBackingFilter<Classe, Long> {
	...
	@Override
	public ClasseFilter getFilterDecoded() {
		ClasseFilter filter = new ClasseFilter();
	...
	public String toString() {
		return "ClasseFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnLike=" + nomeEnLike

...
public class CorCabeloFilter extends AbstractBackingFilter<CorCabelo, Long> {
	...
	@Override
	public CorCabeloFilter getFilterDecoded() {
		CorCabeloFilter filter = new CorCabeloFilter();
	...
	public String toString() {
		return "CorCabeloFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnLike=" + nomeEnLike

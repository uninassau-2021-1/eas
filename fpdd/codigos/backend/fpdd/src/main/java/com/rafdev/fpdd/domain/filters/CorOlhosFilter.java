...
public class CorOlhosFilter extends AbstractBackingFilter<CorOlhos, Long> {
	...
	@Override
	public CorOlhosFilter getFilterDecoded() {
		CorOlhosFilter filter = new CorOlhosFilter();
	...
	public String toString() {
		return "CorOlhosFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnLike=" + nomeEnLike

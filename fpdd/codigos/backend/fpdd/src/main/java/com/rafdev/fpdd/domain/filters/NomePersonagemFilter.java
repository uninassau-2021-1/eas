...
public class NomePersonagemFilter extends AbstractBackingFilter<NomePersonagem, Long> {
	...
	@Override
	public NomePersonagemFilter getFilterDecoded() {
		NomePersonagemFilter filter = new NomePersonagemFilter();
	...
	public String toString() {
		return "NomePersonagemFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnLike="
				+ nomeEnLike + ", nomePtBrLike=" + nomePtBrLike + ", nomeEsLike=" + nomeEsLike + ", statusEquals="
				+ statusEquals + "]";
	}

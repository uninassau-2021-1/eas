...
public class TendenciaFilter extends AbstractBackingFilter<Tendencia, Long> {
	...
	@Override
	public TendenciaFilter getFilterDecoded() {
		TendenciaFilter filter = new TendenciaFilter();
	...
	public String toString() {
		return "TendenciaFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", nomeEnLike=" + nomeEnLike

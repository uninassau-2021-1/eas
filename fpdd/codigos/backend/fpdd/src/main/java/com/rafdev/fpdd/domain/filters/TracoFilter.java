...
public class TracoFilter extends AbstractBackingFilter<Traco, Long> {
	...
	@Override
	public TracoFilter getFilterDecoded() {
		TracoFilter filter = new TracoFilter();
	...
	public String toString() {
		return "TracoFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", antecedenteEquals="

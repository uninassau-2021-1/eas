...
public class VinculoFilter extends AbstractBackingFilter<Vinculo, Long> {
	...
	@Override
	public VinculoFilter getFilterDecoded() {
		VinculoFilter filter = new VinculoFilter();
	...
	public String toString() {
		return "VinculoFilter [idEquals=" + idEquals + ", idNotEquals=" + idNotEquals + ", antecedenteEquals="
